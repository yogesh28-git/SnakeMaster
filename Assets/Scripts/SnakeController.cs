...
public class SnakeController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.D) && facing != Direction.left)
        {
            pressed = Direction.right;
        }
        if (Input.GetKeyDown(KeyCode.W) && facing != Direction.down)
        {
            pressed = Direction.up;
        }
        if (Input.GetKeyDown(KeyCode.S) && facing != Direction.up)
        {
